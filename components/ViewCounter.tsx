...
const ViewCounter: React.FC = () => {
  ...
  return (
    <div className="glass px-2 py-1.5 sm:px-4 sm:py-2.5 rounded-xl sm:rounded-2xl flex items-center gap-1.5 sm:gap-2 text-white select-none pointer-events-auto shadow-xl transition-all hover:scale-105 border border-white/20">
      <div className="w-5 h-5 sm:w-7 sm:h-7 rounded-lg bg-blue-500/20 flex items-center justify-center border border-blue-500/30">
      ...
      <div className="flex flex-col">
        <span className="text-[6px] sm:text-[9px] font-black uppercase tracking-widest text-blue-400/80 leading-none mb-0.5">Live Traffic</span>
